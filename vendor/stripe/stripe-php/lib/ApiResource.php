...
abstract class ApiResource extends StripeObject
{
    ...
    /**
     * @return string the base URL for the given classes
     */
    ...
    /**
     * @return string the endpoint URL for the given classes
     */
     ...
     *
     * @return string the instance endpoint URL for the given classes
     */
